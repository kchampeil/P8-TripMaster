...
public class TestConstants {
    ...
    public static final double NYC_LONGITUDE = -74.005941;

    public static final double DISTANCE_LILLE_TO_PARIS_IN_MI = 140D;
    public static final double DISTANCE_NYC_TO_PARIS_IN_MI = 3591D;
}
